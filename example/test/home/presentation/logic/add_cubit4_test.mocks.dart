...
// in example/test/home/presentation/logic/add_cubit4_test.dart.
...
import 'package:example/home/domain/requests/add_comment4_request.dart' as _i16;
...
/// A class which mocks [AddComment4UseCase].
///
/// See the documentation for Mockito's code generation for more information.
class MockAddComment4UseCase extends _i1.Mock
    implements _i11.AddComment4UseCase {
  @override
  ...
  _i12
      ...
      execute({_i16.AddComment4Request? request}) => (super.noSuchMethod(
            Invocation.method(
              #execute,
              [],
              {#request: request},
