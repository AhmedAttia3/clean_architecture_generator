...
// in example/test/home/presentation/logic/add_cubit5_test.dart.
...
import 'package:example/home/domain/requests/add_comment5_request.dart' as _i16;
...
/// A class which mocks [AddComment5UseCase].
///
/// See the documentation for Mockito's code generation for more information.
class MockAddComment5UseCase extends _i1.Mock
    implements _i11.AddComment5UseCase {
  @override
  ...
  _i12
      ...
      execute({_i16.AddComment5Request? request}) => (super.noSuchMethod(
            Invocation.method(
              #execute,
              [],
              {#request: request},
