...
// in example/test/home/presentation/logic/add_cubit3_test.dart.
...
import 'package:example/home/domain/requests/add_comment3_request.dart' as _i16;
...
/// A class which mocks [AddComment3UseCase].
///
/// See the documentation for Mockito's code generation for more information.
class MockAddComment3UseCase extends _i1.Mock
    implements _i11.AddComment3UseCase {
  @override
  ...
  _i12
      ...
      execute({_i16.AddComment3Request? request}) => (super.noSuchMethod(
            Invocation.method(
              #execute,
              [],
              {#request: request},
