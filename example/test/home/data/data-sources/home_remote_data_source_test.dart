...
void main() {
  ...
  getResult() => dataSource.getResult(
        countryId: 0,
        termId: 0,
        studentName: "studentName",
        sittingNumber: "sittingNumber",
      );
  addFavorite() => dataSource.addFavorite(
        countryId: 0,
      );
  ...
  group('HomeRemoteDataSource RemoteDataSource', () {
    ...
    test('getResult Success', () async {
      when(networkInfo.isConnected).thenAnswer((realInvocation) async => true);
      when(getResult()).thenAnswer((realInvocation) async => getResultResponse);
      final res = await remoteDataSource.getResult(
        countryId: 0,
        termId: 0,
        studentName: "studentName",
        sittingNumber: "sittingNumber",
    ...
    test('addFavorite Success', () async {
      ...
      final res = await remoteDataSource.addFavorite(
        countryId: 0,
      );
