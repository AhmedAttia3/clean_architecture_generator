...
///[GetCacheLoginUseCase]
///[Implementation]
@injectable
class GetCacheLoginUseCase implements BaseUseCase<Either<Failure, UserEntity>, Void?>{
final SettingsRepository repository;
const GetCacheLoginUseCase(
this.repository,
);

@override
Either<Failure, UserEntity> execute({Void? request,}) {
return repository.getCacheLogin();
}
