...
///[Implementation]
@injectable
class GetSavedProductsUseCase implements BaseUseCase<Future<Either<Failure, BaseResponse<ProductModel?>>>,GetSavedProductsRequest>{
...
@override
Future<Either<Failure, BaseResponse<ProductModel?>>> execute({GetSavedProductsRequest? request,}) async {
