...
Future<Either<Failure, BaseResponse<List<ProductModel>?>>> getSavedProducts({required int page,required int limit, });
Future<Either<Failure, Unit>> cacheSavedProducts({required List<ProductModel> data,});
...
Future<Either<Failure, BaseResponse<List<SettingsModel>?>>> getApp({required int page,required int limit, });
