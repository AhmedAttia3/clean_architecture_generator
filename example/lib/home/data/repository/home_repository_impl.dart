...
@override
Future<Either<Failure, BaseResponse<DeviceSettingsEntity?>>> addComment6({required String  storyId1,required String  content1, })async {
return await homeRemoteDataSource.addComment6(storyId1: storyId1,content1: content1,);
}

@override
Future<Either<Failure, BaseResponse<DeviceSettingsEntity?>>> addComment7({required String  storyId2,required String  content2, })async {
return await homeRemoteDataSource.addComment7(storyId2: storyId2,content2: content2,);
}

@override
Future<Either<Failure, BaseResponse<DeviceSettingsEntity?>>> addComment8({required String  storyId3,required String  content3, })async {
return await homeRemoteDataSource.addComment8(storyId3: storyId3,content3: content3,);
}
