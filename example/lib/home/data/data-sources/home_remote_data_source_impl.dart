...
@override
Future<Either<Failure, BaseResponse<ResultModel?>>> getResult({required int countryId,required int termId,required String studentName,required String sittingNumber, })async {
