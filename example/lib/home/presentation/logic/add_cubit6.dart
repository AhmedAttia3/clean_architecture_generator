...
class AddCubit6 extends Cubit<FlowState> {
  ...
  Future<void> executeAddComment6({
    required String storyId1,
  }) async {
    if (addComment6FormKey.currentState!.validate()) {
      addComment6Request.content1 = content1.text;
  ...
  Future<void> executeAddComment7({
    required String storyId2,
  }) async {
    if (addComment7FormKey.currentState!.validate()) {
      addComment7Request.content2 = content2.text;
  ...
  Future<void> executeAddComment8({
    required String storyId3,
  }) async {
    if (addComment8FormKey.currentState!.validate()) {
      addComment8Request.content3 = content3.text;
