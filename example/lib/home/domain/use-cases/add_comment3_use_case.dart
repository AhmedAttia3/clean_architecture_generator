...
///[Implementation]
@injectable
class AddComment3UseCase implements BaseUseCase<AddComment3Request,Future<Either<Failure, BaseResponse<DeviceSettingsEntity?>>>>{
...
@override
Future<Either<Failure, BaseResponse<DeviceSettingsEntity?>>> execute({AddComment3Request? request,}) async {
