...
///[Implementation]
@injectable
class AddComment5UseCase implements BaseUseCase<AddComment5Request,Future<Either<Failure, BaseResponse<DeviceSettingsEntity?>>>>{
...
@override
Future<Either<Failure, BaseResponse<DeviceSettingsEntity?>>> execute({AddComment5Request? request,}) async {
